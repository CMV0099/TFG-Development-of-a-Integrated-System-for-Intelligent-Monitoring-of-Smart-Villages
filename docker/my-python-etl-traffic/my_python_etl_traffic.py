...
def cargar_datos(conn, nombre_tabla, token, fecha_inicio, fecha_fin):
    ...
    if resultado.status_code == 200:
            ...
            query = sql.SQL("INSERT INTO {table} (nombreDispositivo, nombreZona, tipo, fecha, contador, matricula, sentido, color, pais) VALUES %s").format(table=sql.Identifier(nombre_tabla))
